...
if (!room) {
  ...
  urlInput.innerHTML = window.location.href + '#' + room;
}
...
let pc = new RTCPeerConnection(server, pcOptions);
...
function connect() {
  ...
  function bindChannelEvents() {
    ...
    channel.onmessage = function(e) {
      ...
      const textNode = document.createTextNode(Date.now() + ': ' + e.data);
